						...
						'fields' => [
							...
							$prefix . 'button_icon_color'   => [
								...
								'selectors' => [
									...
									'{{WRAPPER}} ' . $selector_prefix . '.box-button svg, {{WRAPPER}} ' . $selector_prefix . '.box-button.elementor-button:hover svg, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button.elementor-button svg' => 'fill: {{VALUE}}; color: {{VALUE}};',
								],
							],
						...
						'fields' => [
							$prefix . 'button_hover_color'        => [
								...
								'selectors' => [
									...
									'{{WRAPPER}} ' . $selector_prefix . '.box-button.elementor-button:hover svg, {{WRAPPER}} .box-hover:hover ' . $selector_prefix . '.box-button.elementor-button svg' => 'fill: {{VALUE}}; color: {{VALUE}};',
								],
							],
