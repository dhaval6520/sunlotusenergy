		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .portfolio-shortcode .project-links-container a > svg, {{WRAPPER}} .project-links-container a > svg'             => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .portfolio-shortcode .project-links-container a:hover > svg, {{WRAPPER}} .project-links-container a:hover > svg' => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
